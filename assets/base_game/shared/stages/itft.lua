...
makeLuaSprite('logos', 'rendersnlogos/time titlecard',0,0)
...
setTextFont('timefor','Consolas.TTF')
...
addAnimationByIndices('s','sdance','Sundance0','8,9,10,11,12,13,14',14,true)
...
setProperty('p.x',getProperty('p.x')+42.5)
setProperty('p.y',getProperty('p.y')+637.5)
end
end
