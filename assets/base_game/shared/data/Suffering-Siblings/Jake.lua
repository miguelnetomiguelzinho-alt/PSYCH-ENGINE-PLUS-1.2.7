...
function onCreate()
	makeAnimatedLuaSprite(name_of_character, 'characters/' .. name_of_character_xml, 2000, 2000);
...
function onBeatHit()
	...
	if curBeat % 2 == 0 then
	setProperty('Jake.x', (getProperty('dad.x')+250))
...
setProperty('Jake.y', (getProperty('dad.y')+50))
