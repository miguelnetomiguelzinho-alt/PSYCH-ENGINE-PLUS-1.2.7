...
setProperty('POPEYE.alpha',1)
scaleObject('POPEYE', 40.0, 40.0)
makeGraphic('POPEYE', 320, 180, 'ffffff')
setBlendMode('POPEYE', 'SUBTRACT')
addLuaSprite('POPEYE', true)
screenCenter('POPEYE', 'xy')

makeLuaText('alerta', '[WARNING FLASHLIGHT]  ', 0,160,285)
setTextSize('alerta', 100)
setProperty('alerta.alpha',1)
setTextFont('alerta', 'Adult-Swim-Font.ttf')
setTextColor('alerta', '8b0000')
setObjectCamera('alerta', 'other')
addLuaText('alerta', true)

initLuaShader("Glitchy")
setSpriteShader('opponentStrums.members[0]', 'Glitchy3')
setSpriteShader('opponentStrums.members[1]', 'Glitchy3')
setSpriteShader('opponentStrums.members[2]', 'Glitchy3')
setSpriteShader('opponentStrums.members[3]', 'Glitchy3')

setShaderFloat('opponentStrums.members[0]', 'AMT', 0.2)
setShaderFloat('opponentStrums.members[0]', 'SPEED', 0.3)
setShaderFloat('opponentStrums.members[1]', 'AMT', 0.2)
setShaderFloat('opponentStrums.members[1]', 'SPEED', 0.3)
setShaderFloat('opponentStrums.members[2]', 'AMT', 0.2)
setShaderFloat('opponentStrums.members[2]', 'SPEED', 0.3)
setShaderFloat('opponentStrums.members[3]', 'AMT', 0.2)
